...
class RSMAEnv():
    ...
    def step(self, action):
        ...
        next_reward, next_sumrate = self.getReward(action, self.state)
...
if __name__ == "__main__":
    ...
    # agent = DDPGAgent(state_dim, action_dim, max_action, 1e-4,1e-3,0.99,0.01,256)
    #Hyperparameters
